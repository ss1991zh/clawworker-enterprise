...
标量明文或数组明文 `maximum`：返回两个输入数组的最大元素，如果被比较的元素之一是 NaN，则返回 NaN。
...
res = hp.maximum(a_nan, b_nan)
print(ct.decrypt(res))
# 输出 [2.1 nan 4.3 5.2 nan]

# 标量和向量
res = hp.maximum(x2, b_nan)
print(ct.decrypt(res))
# 输出 [ 3.   nan  4.   5.2 40.5]
